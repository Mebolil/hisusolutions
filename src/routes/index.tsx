...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Türkiye'nin AaaS platformu. Otomasyon, BütçeCRM ve özel tasarım siteler — işinize özel kurulur, teslim edilir." },
    ],
  }),
  component: HomePage,
});
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-20 text-center lg:px-8 lg:pt-28">
          ...
          <h1 className="mx-auto mt-6 max-w-4xl text-5xl font-bold tracking-tight md:text-7xl">
            İşinizi Büyütün. <span className="text-primary">Sistemi Biz Kurarız.</span>
          </h1>
