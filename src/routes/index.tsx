    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Hisu Solutions hangi hizmetleri sunuyor?", "acceptedAnswer": { "@type": "Answer", "text": "İki ana hizmet: BütçeCRM (e-ticaret KOBİ'leri için reklam ROAS takibi ve finansal yönetim yazılımı, aylık ₺719) ve Uçtan Uca Yazılım (işletmenin tüm süreçlerini tek panelde toplayan, sektöre özel kurulan anahtar teslim yazılım çözümü, proje bazlı fiyatlandırma)." } },
...
const faqs: FaqItem[] = [
  ...
  { q: "Hisu Solutions hangi hizmetleri sunuyor?", a: "İki ana hizmet: BütçeCRM (e-ticaret KOBİ'leri için reklam ROAS takibi ve finansal yönetim yazılımı, aylık ₺719) ve Uçtan Uca Yazılım (işletmenin tüm süreçlerini tek panelde toplayan, sektöre özel kurulan anahtar teslim yazılım çözümü, proje bazlı fiyatlandırma)." },
